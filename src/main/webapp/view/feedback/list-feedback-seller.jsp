                            ...
                            <div class="main-content-wrap">
                                ...
                                <div class="flex items-center justify-between flex-wrap gap10">
                                    ...
                                    <ul class="wg-pagination">
                                        ...
                                        <c:if test="${not empty param.action}"><c:set var="queryString" value="${queryString}&action=${param.action}"/></c:if>
                                        <c:if test="${not empty search}"><c:set var="queryString" value="${queryString}&search=${search}"/></c:if>
                                        <c:if test="${not empty rating}"><c:set var="queryString" value="${queryString}&rating=${rating}"/></c:if>
                                        <c:if test="${not empty sort}"><c:set var="queryString" value="${queryString}&sort=${sort}"/></c:if>

                                        <li class="${currentPage == 1 ? 'disabled' : ''}">
                                            <a href="${pageContext.request.contextPath}/seller/feedback?index=${currentPage - 1}${queryString}"><i class="icon-chevron-left"></i></a>
                                        </li>
                                        ...
                                        <li class="${currentPage == totalPage ? 'disabled' : ''}">
                                            <a href="${pageContext.request.contextPath}/seller/feedback?index=${currentPage + 1}${queryString}"><i class="icon-chevron-right"></i></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
