          ...
          <div class="main-content">
            ...
            <div class="main-content-inner">
              ...
              <div class="main-content-wrap">
                ...
                <!-- add-new-user -->
                <form class="add_account" id="userForm"
                  action="${pageContext.request.contextPath}/manage-account?action=add" method="POST">
                  <div class="wg-box">
                    ...
                    <fieldset class="birth-date mb-24">
                      ...
                      <input class="flex-grow" type="text" name="mobile" value="${mobile != null ? mobile : ''}"
                        required>
