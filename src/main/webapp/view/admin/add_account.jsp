                                                                        ...
                                                                        <div class="section-menu-left">
                                                                            <div class="box-logo">
                                                                                <a href="index.html" id="site-logo-inner">
                                                                                    <img class="" id="logo_header" alt="" src="${pageContext.request.contextPath}/images/logo/logo.png" data-light="${pageContext.request.contextPath}/images/logo/logo.png" data-dark="${pageContext.request.contextPath}/images/logo/logo-dark.png" >
                                                                                </a>
                                                                                            ...
                                                                                            <div class="wg-box">   
                                                                                                ...
                                                                                                <div class="right flex-grow">
                                                                                                    ...
                                                                                                    <fieldset class="birth-date mb-24">
                                                                                                        ...
                                                                                                        <input class="flex-grow" type="date" name="birth_data" required>
                                                                                                    </fieldset>
                                                                                                </div>
