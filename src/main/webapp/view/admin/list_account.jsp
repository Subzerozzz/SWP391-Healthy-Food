                ...
                <div class="section-menu-left">
                    <div class="box-logo">
                        <a href="index.html" id="site-logo-inner">
                            <img class="" id="logo_header" alt="" src="${pageContext.request.contextPath}/images/logo/logo.png" data-light="images/logo/logo.png" data-dark="images/logo/logo-dark.png" >
                        </a>
                    ...
                    <div class="section-menu-left-wrap">
                        ...
                        <div class="bot text-center">
                            <div class="wrap">
                                <div class="mb-20">
                                    <img src="${pageContext.request.contextPath}/images/menu-left/img-bot.png" alt="">
                                </div>
                                <div class="mb-20">
                                            ...
                                            <c:forEach items="${listAccount}" var="account">
                                                <li class="user-item gap14">
                                                    ...
                                                    <div class="flex items-center justify-between gap20 flex-grow">
                                                        ...
                                                        <div class="body-text">${account.phone}</div>
                                                        <div class="body-text">${account.email}</div>
                                                        <div class="body-text">${account.role}</div>
                                                        <div class="body-text">${account.action}</div>
                                                        ...
                                                        <div class="list-icon-function">
                                                            ...
                                                            <div class="item edit">
                                                                <a href="manage_account?action=edit&id=${account.id}"><i class="icon-edit-3"></i></a>
                                                            </div>
                                                            <div class="item trash">
                                                                <a href="manage_account?action=deactive&id=${account.id}"><i class="icon-trash-2"></i></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </li>
