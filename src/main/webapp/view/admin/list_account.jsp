                      ...
                      <c:if test="${account.getRole() != 'admin'}">
                        <li class="user-item gap14">
                          ...
                          <div class="flex items-center justify-between gap20 flex-grow">
                            <div class="name">
                              <a href="#" class="body-title-2">${account.user_name == null ? 'null' :
                                account.user_name}</a>
                              <div class="text-tiny mt-3">${account.full_name == null ? 'null' : account.full_name}
                              </div>
                            </div>
                            ...
                            <div class="list-icon-function">
                              ...
                              <label class="switch" title="${account.status eq 'active' ? 'Banned' : 'Activate'}">
                                <input type="checkbox"
                                  ...
                                  <c:if test='${account.status eq "active"}'>checked
                      </c:if>>
            ...
            <div class="flex items-center justify-between flex-wrap gap10">
              ...
              <c:if test="${totalPages > 1}">
                <ul class="wg-pagination">
                  ...
                  <li>
                    <a
                      href="?action=${param.action}&role=${param.role}&status=${param.status}&page=1&pageSize=${pageSize}">
                  ...
                  <c:choose>
                    <c:when test="${currentPage <= totalPages - 2}">
                      <c:if test="${currentPage > 1}">
                        <li>
                          <a
                            href="?action=${param.action}&role=${param.role}&status=${param.status}&page=${currentPage - 1}&pageSize=${pageSize}">
                            ${currentPage - 1}
                          </a>
                        </li>
                      </c:if>
                      ...
                      <li class="active">
                        <a
                          href="?action=${param.action}&role=${param.role}&status=${param.status}&page=${currentPage}&pageSize=${pageSize}">
                          ${currentPage}
                        </a>
                      </li>
                      <li>
                      ...
                      <li>
                        <a
                          href="?action=${param.action}&role=${param.role}&status=${param.status}&page=${totalPages}&pageSize=${pageSize}">
                          ${totalPages}
                        </a>
                      </li>
                    </c:when>
                    ...
                    <c:otherwise>
                      <c:forEach begin="${totalPages - 2 <= 0 ? 1 : totalPages - 2}" end="${totalPages}" var="i">
                        <li class="${currentPage == i ? 'active' : ''}">
                          <a
                            href="?action=${param.action}&role=${param.role}&status=${param.status}&page=${i}&pageSize=${pageSize}">
                            ${i}
                          </a>
                        </li>
                      </c:forEach>
