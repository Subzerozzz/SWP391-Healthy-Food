<%-- 
    Document   : section-menu-left
    Created on : Jun 2, 2025, 8:15:11 PM
    Author     : Hang
--%>
                                                                                        ...
                                                                                        <ul class="menu-list">
                                                                                            ...
                                                                                            <li class="menu-item has-children active">
                                                                                                ...
                                                                                                <ul class="sub-menu" style="display: block;">
                                                                                                    <li class="sub-menu-item">
                                                                                                        <a href="manage-account?action=list" class="active">
                                                                                                            <div class="text">All user</div>
                                                                                                        </a>
                                                                                                    </li>
                                                                                                    <li class="sub-menu-item">
                                                                                                        <a href="${pageContext.request.contextPath}/manage-account?action=add" >
