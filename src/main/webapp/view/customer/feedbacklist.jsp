                                                                                                                    ...
                                                                                                                    <li class="product-item gap14">
                                                                                                                        ...
                                                                                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                                                                                            ...
                                                                                                                            <div class="list-icon-function ">
                                                                                                                                <div class="item edit">
                                                                                                                                    <a href="createfeedback?order_item_id=${feedback.order_item_id}&source=feedback"
                                                                                                    ...
                                                                                                    <div class="flex items-center justify-between flex-wrap gap10">
                                                                                                        ...
                                                                                                        <div class="pagination">
                                                                                                            ...
                                                                                                            <ul class="wg-pagination">
                                                                                                                ...
                                                                                                                <li>
                                                                                                                    <a href="${pageContext.request.contextPath}/feedback?page=1&rating=${param.rating}"><i
                                                                                                                ...
                                                                                                                <c:choose>
                                                                                                                    <c:when test="${currentPage <= totalPages - 2}">
                                                                                                                        <c:if test="${currentPage > 1}">
                                                                                                                            <li class="">
                                                                                                                                <a
                                                                                                                                    href="${pageContext.request.contextPath}/feedback?page=${currentPage - 1}&rating=${param.rating}">${currentPage
                                                                                                                                        - 1}</a>
                                                                                                                            </li>
                                                                                                                        </c:if>
                                                                                                                        <li class="active">
                                                                                                                            <a
                                                                                                                                href="${pageContext.request.contextPath}/feedback?page=${currentPage}&rating=${param.rating}">${currentPage}</a>
                                                                                                                        </li>
                                                                                                                        ...
                                                                                                                        <li class="">
                                                                                                                            <a
                                                                                                                                href="${pageContext.request.contextPath}/feedback?page=${totalPages}&rating=${param.rating}">${totalPages}</a>
                                                                                                                        </li>
                                                                                                                    </c:when>
                                                                                                                    ...
                                                                                                                    <c:otherwise>
                                                                                                                        <c:forEach begin="${totalPages-2 <= 0 ? 1 : totalPages - 2}" end="${totalPages}" var="i">
                                                                                                                            <li class="${currentPage == i ? 'active' : ''}">
                                                                                                                                <a
                                                                                                                                    href="${pageContext.request.contextPath}/feedback?page=${i}&rating=${param.rating}">${i}</a>
                                                                                                                            </li>
                                                                                                                        </c:forEach>
                                                                                                                    </c:otherwise>
                                                                                                                </c:choose>
                                                                                                                ...
                                                                                                                <li>
                                                                                                                    <a
                                                                                                                        href="${pageContext.request.contextPath}/feedback?page=${totalPages}&rating=${param.rating}"><i
