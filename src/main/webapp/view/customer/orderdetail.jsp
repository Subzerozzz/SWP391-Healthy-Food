                                ...
                                <div class="flex items-center justify-between gap40 flex-grow">
                                  ...
                                  <div class="name">
                                    ...
                                    <div class="body-title-2">
                                      <fmt:formatNumber value="${foodDAO.findById(orderItem.food_id).price}"
                          ...
                          <c:if test="${status.first}">
                            <ul class="flex flex-column gap14">
                              ...
                              <li class="cart-totals-item">
                                ...
                                <span class="body-title-2">
                                  <c:choose>
                                    <c:when test="${order.payment_status == 0}"><i style="color: red">Chưa thanh
                                        toán</i></c:when>
                                    <c:when test="${order.payment_status == 1}"><i style="color: green">Đã thanh
                                        toán</i></c:when>
