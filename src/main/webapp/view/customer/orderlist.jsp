...
<head>
  <style>
    ...
    .table-title {
      ...
      /* Hoặc: center, nếu bạn muốn cả dòng nằm giữa */
              ...
              <div class="main-content-wrap">
                ...
                <div class="wg-box">
                  <div class="flex items-center justify-between gap10 flex-wrap">
                    ...
                    <a class="tf-button style-1 w208" href="${pageContext.request.contextPath}/listordercombo"><i
                        class="icon-file-text"></i>List Order Combo</a>
                  </div>
                      ...
                      <c:forEach var="order" items="${orderList}">
                        <li class="product-item gap14">
                          <div class="flex items-center justify-between gap20 flex-grow">
                            ...
                            <div class="body-text format-view"><a
                                class="payment-badge ${order.payment_method}">${order.payment_method}</a></div>
                            <div>
                              <div class="block-available ${order.status}"><a>${order.status}</a></div>
                            </div>
                            <div class="list-icon-function ">
                              <a href="${pageContext.request.contextPath}/orderdetail?order_id=${order.id}"
                                class="item eye">
                                <i class="icon-eye"></i>
                              </a>
                            </div>
                  ...
                  <div class="flex items-center justify-between flex-wrap gap10">
                    ...
                    <div class="pagination">
                      ...
                      <ul class="wg-pagination">
                        ...
                        <li>
                          <a href="${pageContext.request.contextPath}/orderlist?page=1&status=${param.status}"><i
                        ...
                        <c:choose>
                          <c:when test="${currentPage <= totalPages - 2}">
                            <c:if test="${currentPage > 1}">
                              <li class="">
                                <a
                                  href="${pageContext.request.contextPath}/orderlist?page=${currentPage - 1}&status=${param.status}">${currentPage
                                  - 1}</a>
                              </li>
                            </c:if>
                            <li class="active">
                              <a
                                href="${pageContext.request.contextPath}/orderlist?page=${currentPage}&status=${param.status}">${currentPage}</a>
                            </li>
                            ...
                            <li class="">
                              <a
                                href="${pageContext.request.contextPath}/orderlist?page=${totalPages}&status=${param.status}">${totalPages}</a>
                            </li>
                          </c:when>
                          ...
                          <c:otherwise>
                            <c:forEach begin="${totalPages-2 <= 0 ? 1 : totalPages - 2}" end="${totalPages}" var="i">
                              <li class="${currentPage == i ? 'active' : ''}">
                                <a
                                  href="${pageContext.request.contextPath}/orderlist?page=${i}&status=${param.status}">${i}</a>
                              </li>
                            </c:forEach>
                          </c:otherwise>
                        </c:choose>
                        ...
                        <li>
                          <a
                            href="${pageContext.request.contextPath}/orderlist?page=${totalPages}&status=${param.status}"><i
