              ...
              <div class="main-content-wrap">
                ...
                <div class="filter">
                  <div style=" ; height: 40px;">
                    <form style="display: flex;" action="${pageContext.request.contextPath}/type-of-request"
                      method="get" ">
                      <input type="hidden" name="action" value="option">
                      <select name="select" class="selected">
                        <option style="display: flex;align-items: center" value="-1" ${param.select=='-1' ? 'selected'
                          : '' }>--All Type Of Request--</option>
                      ...
                      <button
                        style="margin-left: 20px;justify-content: center;width: 100px;height: 45px;
                        align-items: center;border-radius:60px"
                        type="submit" class="filter-btn">Submit</button>

                    </form>
                  </div>
                  <div>
                    <form class="form-search flex-grow" action="${pageContext.request.contextPath}/type-of-request"
                      method="post">
                  ...
                  <div class="table-pagination-container">
                      ...
                      <tbody>
                        ...
                        <c:forEach items="${listFoodDraft}" var="foodD">
                          <tr>
                            ...
                            <td>
                              <div class="item eye">
                                <a href="type-of-request?action=view&select=${foodD.getType()}&id=${foodD.getId()}"
                                  title="View Detail">
                                  <i class="icon-eye"></i>
                                </a>
                              </div>
                            ...
                            <td>
                              <div class="item edit">
                                <a href="type-of-request?action=accept&select=${foodD.getType()}&id=${foodD.getId()}"
                                  onclick="handleAccept(event)" title="Accept">
                                  <i class="fa-solid fa-check"></i>
                                </a>
                              </div>
                              <a href="type-of-request?action=reject&select=${foodD.getType()}&id=${foodD.getId()}"
                                onclick="handleReject(event)" title="Reject">
                    ...
                    <div class="pagination-wrapper">
                      ...
                      <ul class="pagination-wrapper">
                        ...
                        <li>
                          <a
                            href="${pageContext.request.contextPath}/type-of-request?page=1&action=option&select=${select}"><i
                        ...
                        <c:choose>
                          <c:when test="${currentPage <= totalPages - 2}">
                            <c:if test="${currentPage > 1}">
                              <li class="">
                                <a
                                  href="${pageContext.request.contextPath}/type-of-request?page=${currentPage - 1}&action=option&select=${select}">${currentPage
                                  - 1}</a>
                              </li>
                            </c:if>
                            <li class="active">
                              <a
                                href="${pageContext.request.contextPath}/type-of-request?page=${currentPage}&action=option&select=${select}">${currentPage}</a>
                            </li>
                            ...
                            <li class="">
                              <a
                                href="${pageContext.request.contextPath}/type-of-request?page=${totalPages}&action=option&select=${select}">${totalPages}</a>
                            </li>
                          </c:when>
                          ...
                          <c:otherwise>
                            <c:forEach begin="${totalPages-2 <= 0 ? 1 : totalPages - 2}" end="${totalPages}" var="i">
                              <li class="${currentPage == i ? 'active' : ''}">
                                <a
                                  href="${pageContext.request.contextPath}/type-of-request?page=${i}&action=option&select=${select}">${i}</a>
                              </li>
                            </c:forEach>
                          </c:otherwise>
                        </c:choose>
                        ...
                        <li>
                          <a
                            href="${pageContext.request.contextPath}/type-of-request?page=${totalPages}&action=option&select=${select}"><i
