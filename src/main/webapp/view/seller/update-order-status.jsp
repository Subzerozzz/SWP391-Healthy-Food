              ...
              <div class="main-content-wrap">
                <div class="flex items-center flex-wrap justify-between gap20 mb-27">
                  <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                    ...
                    <li>
                      <a href="#">
                        <div class="text-tiny">Order Status</div>
                      </a>
                    </li>
                    <li>
                      <i class="icon-chevron-right"></i>
                      ...
                      <div class="card">
                        ...
                        <div class="card-body">
                          <c:choose>
                            ...
                            <c:when
                              test="${order.status == 'accepted' || order.status == 'cancelled'|| order.status == 'completed'}">
                              <div class="mb-3">
                            ...
                            <c:otherwise>
                              <form action="${pageContext.request.contextPath}/seller/manage-order" method="post">
                                ...
                                <select class="form-select" name="newStatus" id="newStatusSelect" required
                                  onchange="toggleFieldsByStatus()" style="margin: 10px 0">
