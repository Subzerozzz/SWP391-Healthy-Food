...
<head>
  ...
  <style>
    ...
    .filter-row {
      display: grid;
      grid-template-columns: 150px 500px 100px;
      /* 3 cột */
      gap: 50px;
      align-items: center;
      width: 100%;
                  ...
                  <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                    ...
                    <li>
                      <a href="${pageContext.request.contextPath}/seller/manage-delivery">
                        <div class="text-tiny">Deliveries List</div>
                      </a>
                    </li>
                    <li>
                      <i class="icon-chevron-right"></i>
                    ...
                    <li>
                      <a href="#">
                        <div class="text-tiny">Shipper List</div>
                      </a>
                    </li>
                    <li>
                      <i class="icon-chevron-right"></i>
                          ...
                          <div class="card-body p-24">
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        <span
                                          ...
                                          ${deliveryDAO.getNumberDeliveryOfShipper(shipper.id) > 0 ? 'Đang giao' :
                                          'Rảnh'}
                                        </span>
                                      </td>
                            ...
                            <div class="pagination-wrapper">
                              ...
                              <ul class="pagination-wrapper">
                                ...
                                <li>
                                  <a
                                    href="${pageContext.request.contextPath}/seller/manage-delivery?action=shipper&id=${de.id}&page=1&search=${search}&sort=${sort}"><i
                                ...
                                <c:choose>
                                  <c:when test="${currentPage <= totalPages - 2}">
                                    <c:if test="${currentPage > 1}">
                                      <li class="">
                                        <a
                                          href="${pageContext.request.contextPath}/seller/manage-delivery?action=shipper&id=${de.id}&page=${currentPage - 1}&search=${search}&sort=${sort}">${currentPage
                                          - 1}</a>
                                      </li>
                                    </c:if>
                                    <li class="active">
                                      <a
                                        href="${pageContext.request.contextPath}/seller/manage-delivery?action=shipper&id=${de.id}&page=${currentPage}&search=${search}&sort=${sort}">${currentPage}</a>
                                    </li>
                                    ...
                                    <li class="">
                                      <a
                                        href="${pageContext.request.contextPath}/seller/manage-delivery?action=shipper&id=${de.id}&page=${totalPages}&search=${search}&sort=${sort}">${totalPages}</a>
                                    </li>
                                  </c:when>
                                  ...
                                  <c:otherwise>
                                    <c:forEach begin="${totalPages-2 <= 0 ? 1 : totalPages - 2}" end="${totalPages}"
                                      ...
                                      <li class="${currentPage == i ? 'active' : ''}">
                                        <a
                                          href="${pageContext.request.contextPath}/seller/manage-delivery?action=shipper&id=${de.id}&page=${i}&search=${search}&sort=${sort}">${i}</a>
                                      </li>
                                    </c:forEach>
                                  </c:otherwise>
                                </c:choose>
                                ...
                                <li>
                                  <a
                                    href="${pageContext.request.contextPath}/seller/manage-delivery?action=shipper&id=${de.id}&page=${totalPages}&search=${search}&sort=${sort}"><i
