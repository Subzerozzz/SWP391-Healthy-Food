                                                                ...
                                                                <link rel="shortcut icon" href="${pageContext.request.contextPath}/images/favicon_1.png">
                                                                    <link rel="apple-touch-icon-precomposed" href="${pageContext.request.contextPath}/images/favicon_1.png">
                                                                        <style>
                                                                            ...
                                                                            .feedback-table th:nth-child(1), td:nth-child(1) {
                                                                                width: 70px;
                                                                            }     /* ID */
                                                                            .feedback-table th:nth-child(2), td:nth-child(2) {
                                                                                width: 120px;
                                                                            }    /* Food */
                                                                            .feedback-table th:nth-child(3), td:nth-child(3) {
                                                                                width: 130px;
                                                                            }    /* Rating */
                                                                            .feedback-table th:nth-child(5), td:nth-child(5) {
                                                                                width: 150px;
                                                                            }    /* Customer */
                                                                            .feedback-table th:nth-child(6), td:nth-child(6) {
                                                                                width: 100px;
                                                                                text-align: center;
                                                                            }
                                                                            .feedback-table th:nth-child(7), td:nth-child(7) {
                                                                                width: 140px;
                                                                            }
                                                                            .feedback-table th:nth-child(8), td:nth-child(8) {
                                                                                width: 100px;
                                                                                text-align: center;
                                                                            }
