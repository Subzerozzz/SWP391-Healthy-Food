                ...
                <div class="filter-search-wrapper">
                  <div class="filter-search-container">
                    <div class="left-controls">
                      <form class="form-search" action="${pageContext.request.contextPath}/seller/feedback"
                        method="GET">
                    ...
                    <form class="search-box" action="${pageContext.request.contextPath}/seller/feedback" method="get">
                      ...
                      <div class="search-container">
                        <input type="text" name="search" placeholder="Search by customer name, email..."
                          value="${search}">
                          ...
                          <p>
                            <c:choose>
                              <c:when test="${not empty rating || not empty search}">
                                ...
                                <br />
                                <a href="${pageContext.request.contextPath}/seller/feedback"
                                  class="btn btn-sm btn-link text-primary fw-bold">
                                  Clear Filters
                                </a>
                              </c:when>
                              <c:otherwise>
                    ...
                    <c:forEach items="${feedbacks}" var="feedback">
                      <div class="table-row">
                        ...
                        <div class="col col-food">
                          <c:choose>
                            <c:when test="${not empty foodNameMap[feedback.order_item_id]}">
                              <a
                                href="${pageContext.request.contextPath}/seller/feedback?action=food&food_id=${foodIdMap[feedback.order_item_id]}">${foodNameMap[feedback.order_item_id]}</a>
                            </c:when>
                        ...
                        <div class="col col-customer">
                          <c:choose>
                            <c:when test="${not empty accountMap[feedback.user_id]}">
                              <a
                                href="${pageContext.request.contextPath}/seller/feedback?action=account&account_id=${feedback.user_id}">${accountMap[feedback.user_id].full_name}</a>
                            </c:when>
                            <c:otherwise>N/A</c:otherwise>
                          </c:choose>
                        </div>
                        ...
                        <div class="col col-action actions">
                          <a
                            href="${pageContext.request.contextPath}/seller/feedback?action=view&feedbackId=${feedback.id}"><i
                              class="icon-eye"></i></a>

                          <form action="${pageContext.request.contextPath}/seller/feedback" method="post"
                            class="status-form">
                            <input type="hidden" name="action" value="update" />
                            <input type="hidden" name="feedbackId" value="${feedback.id}" />
                            <label class="switch">
                              <input type="checkbox" <c:if test="${feedback.visible}">checked</c:if>
                ...
                <div class="flex items-center justify-between flex-wrap gap10">
                  ...
                  <ul class="wg-pagination">
                    ...
                    <li class="${currentPage == 1 ? 'disabled' : ''}">
                      <a
                        href="${pageContext.request.contextPath}/seller/feedback?index=${currentPage - 1}${queryString}">
                    ...
                    <c:if test="${totalPage > 1}">
                      <li class="${currentPage == totalPage ? 'active' : ''}">
                        <a
                          href="${pageContext.request.contextPath}/seller/feedback?index=${totalPage}${queryString}">${totalPage}</a>
                      </li>
                    </c:if>
