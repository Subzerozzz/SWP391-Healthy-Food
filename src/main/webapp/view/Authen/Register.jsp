                        ...
                        <div class="contact-form">
                            ...
                            <form>
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <input class="form-control" type="password" name="password" placeholder="Password (ex:8-32char)">
                                        </div>
                                    </div>
                            ...
                            <div class="footer-widget footer-widget-color-2">
                                ...
                                <ul class="footer-list-contact">
                                    ...
                                    <li>
                                        ...
                                        <a href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection#d5bdb0b9b9ba95bdbcb9bafbb6bab8"><span class="__cf_email__" data-cfemail="4c24292020230c24252023622f2321">[email&#160;protected]</span></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
