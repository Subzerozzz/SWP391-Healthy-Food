    ...
    <%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
      ...
      <body>
        ...
        <div class="checkout-area pt-100 pb-70">
          <div class="container">
            <div class="row align-items-center">
              <form id="contactForm" class="row" action="${pageContext.request.contextPath}/cart?action=checkout"
                method="POST">
                <c:choose>
                            ...
                            <div class="payment-method-section">
                              ...
                              <div class="payment-option">
                                <div class="payment-label">
                                  ...
                                  <div class="payment-icon">
                                    <iconify-icon icon="uil:money-bill" width="24" height="24"
                                      style="color: #80b82d;"></iconify-icon>
                                  </div>
                                  <label for="cash-on-delivery">Cash On Delivery</label>
                                </div>
                                <div class="payment-details">
                                  Pay with cash upon delivery. Please have the exact amount ready for our delivery
                                  personnel.
                                </div>
                              </div>
                              ...
                              <div class="payment-option active">
                                <div class="payment-label">
                                  ...
                                  <div class="payment-icon">
                                    <iconify-icon icon="mdi:bank-outline" width="24" height="24"
                                      style="color: #80b82d;"></iconify-icon>
                                  </div>
                                ...
                                <div class="payment-details">
                                  ...
                                  payment reference. Your order won't be processed until the funds have cleared in our
                                  account.
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-6">
                              <div class="form-group">
                                <label>User Name</label>
                                <input name="userName" type="text" class="form-control"
                                  placeholder=" User Name(không bắt buộc*)" value="${acc.getUser_name()}">
                              </div>
                            </div>
                            ...
                            <div class="payment-method-section">
                              ...
                              <div class="payment-option">
                                <div class="payment-label">
                                  <input type="radio" id="cash-on-delivery" name="paymentMethod" value="cod" 
                                         <c:if test="${(not empty paymentMethod and paymentMethod == 'cod') or empty paymentMethod}">checked</c:if>>
                                  <div class="payment-icon">
                                    <iconify-icon icon="uil:money-bill" width="24" height="24"
                                      style="color: #80b82d;"></iconify-icon>
                                  </div>
                              ...
                              <div class="payment-option active">
                                <div class="payment-label">
                                  <input type="radio" name="paymentMethod" id="bank-transfer" value="vnpay" 
                                         <c:if test="${not empty paymentMethod and paymentMethod == 'vnpay'}">checked</c:if>>
                                  <div class="payment-icon">
                                    <iconify-icon icon="mdi:bank-outline" width="24" height="24"
                                      style="color: #80b82d;"></iconify-icon>
                                  </div>
                  ...
                  <div class="checkout-form">
                    <div class="contact-form">
                      ...
                      <div class="col-lg-12 col-md-12">
                        <button onclick="return this.closest('form').submit()" class="default-btn btn-bg-three">
                          Place Order
                        </button>
                      </div>
                    </div>
