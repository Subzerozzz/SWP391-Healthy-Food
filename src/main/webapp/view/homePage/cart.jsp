<%-- 
    Document   : cart
    Created on : Jun 14, 2025, 7:45:00 PM
    Author     : Dell
--%>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="product-thumbnail">
                                                    <a href="#">
                                                        <img src="${pageContext.request.contextPath}/images/products/products-img1.png" alt="Image">
                                                    </a>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="product-thumbnail">
                                                    <a href="#">
                                                        <img src="${pageContext.request.contextPath}/images/products/products-img2.png" alt="Image">
                                                    </a>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="product-thumbnail">
                                                    <a href="#">
                                                        <img src="${pageContext.request.contextPath}/images/products/products-img3.png" alt="Image">
                                                    </a>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="product-thumbnail">
                                                    <a href="#">
                                                        <img src="${pageContext.request.contextPath}/images/products/products-img4.png" alt="Image">
                                                    </a>
                                                </td>
