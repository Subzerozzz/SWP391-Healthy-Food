                            ...
                            <form action="${pageContext.request.contextPath}/shipper/manage-delivery" method="GET">
                              ...
                              <div class="filter-row">
                                ...
                                <input type="text" class="form-control" name="search"
                                  placeholder="Search by customer name, email..." value="${search}" />
   ...
   <div class="item eye">
                            ...
                            <div class="pagination-wrapper">
                              ...
                              <ul class="pagination-wrapper">
                                ...
                                <li>
                                  <a
                                    href="${pageContext.request.contextPath}/shipper/manage-delivery?page=1&status=${status}&search=${search}&sort=${sort}"><i
                                ...
                                <c:choose>
                                  <c:when test="${currentPage <= totalPages - 2}">
                                    <c:if test="${currentPage > 1}">
                                      <li class="">
                                        <a
                                          href="${pageContext.request.contextPath}/shipper/manage-delivery?page=${currentPage - 1}&status=${status}&search=${search}&sort=${sort}">${currentPage
                                          - 1}</a>
                                      </li>
                                    </c:if>
                                    <li class="active">
                                      <a
                                        href="${pageContext.request.contextPath}/shipper/manage-delivery?page=${currentPage}&status=${status}&search=${search}&sort=${sort}">${currentPage}</a>
                                    </li>
                                    ...
                                    <li class="">
                                      <a
                                        href="${pageContext.request.contextPath}/shipper/manage-delivery?page=${totalPages}&status=${status}&search=${search}&sort=${sort}">${totalPages}</a>
                                    </li>
                                  </c:when>
                                  ...
                                  <c:otherwise>
                                    <c:forEach begin="${totalPages-2 <= 0 ? 1 : totalPages - 2}" end="${totalPages}"
                                      ...
                                      <li class="${currentPage == i ? 'active' : ''}">
                                        <a
                                          href="${pageContext.request.contextPath}/shipper/manage-delivery?page=${i}&status=${status}&search=${search}&sort=${sort}">${i}</a>
                                      </li>
                                    </c:forEach>
                                  </c:otherwise>
                                </c:choose>
                                ...
                                <li>
                                  <a
                                    href="${pageContext.request.contextPath}/shipper/manage-delivery?page=${totalPages}&status=${status}&search=${search}&sort=${sort}"><i
