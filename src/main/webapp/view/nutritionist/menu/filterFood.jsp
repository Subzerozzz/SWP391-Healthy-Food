                    ...
                    <div class="wg-box">
                      ...
                      <div class="flex items-center justify-between flex-wrap gap10">
                        ...
                        <ul class="wg-pagination">
                          ...
                          <li>
                            <a
                              href="${pageContext.request.contextPath}/manage-food?action=paginationFilter&category=${categoryID}&page=1"><i
                          ...
                          <c:choose>
                            <c:when test="${currentPage <= totalPage - 2}">
                              ...
                              <li class="">
                                <a
                                  href="${pageContext.request.contextPath}/manage-food?action=paginationFilter&category=${categoryID}&page=${currentPage + 1}">${currentPage
                                  + 1}</a>
                              </li>
                              ...
                              <li class="">
                                <a
                                  href="${pageContext.request.contextPath}/manage-food?action=paginationFilter&category=${categoryID}&page=${totalPage}">${totalPage}</a>
                              </li>
                            </c:when>
                            <c:otherwise>
                              <c:forEach begin="${totalPage-2 <= 0 ? 1 : totalPage - 2}" end="${totalPage}" var="i">
                                <li class="${currentPage == i ? 'active' : ''}">
                                  <a
                                    href="${pageContext.request.contextPath}/manage-food?action=paginationFilter&category=${categoryID}&page=${i}">${i}</a>
                                </li>
                              </c:forEach>
                            </c:otherwise>
                          ...
                          <li>
                            <a
                              href="${pageContext.request.contextPath}/manage-food?action=paginationFilter&category=${categoryID}&page=${totalPage}"><i
