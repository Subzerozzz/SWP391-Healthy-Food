                  ...
                  <div class="dashboard-main-body">
                    ...
                    <div class="card">
                      <div class="card-body p-24">
                        <form id="comboForm" action="${pageContext.request.contextPath}/managerCombo?action=add"
                          method="post">
                          ...
                          <div class="row g-3">
                            <div class="col-md-6">
                              <label for="name" class="form-label combo-status">Combo Name <span
                            ...
                            <div class="col-md-6">
                              <label for="status" class="form-label combo-status">Status <span
                                  class="text-danger">*</span></label>
                              <select class="form-select combo-status"
                                style="width: 531.6px;height: 47px ;border: none; border: 1px solid #ced4da;
                                                                                                                            outline: none " id="status"
                            ...
                            <div class="col-md-12">
                              ...
                              <textarea class="form-control combo-status" id="description" name="description" rows="3"
                                placeholder="Enter detailed description of the combo">${param.description != null ? param.description : ''}</textarea>
                            </div>
                          </div>
                              ...
                              <div class="food-selection-container ">
                                <div class="food-selection-row row mb-3">
                                  <div class="col-md-8 combo-status">
                                    <select class="form-control food-select combo-status"
                                      style="width: 531.6px;height: 47px ;border: none; border: 1px solid #ced4da;
                          ...
                          <div class="row mt-4">
                            <div class="col-12 text-end">
                              ...
                              <a href="${pageContext.request.contextPath}/managerCombo"
                                class="btn btn-secondary ms-2 combo-status">
                        ...
                        <style>
                          ...
                          .combo-status {
                            font-size: 14px;
                            /* giữ size bình thường cho select */
                          }
                        </style>
