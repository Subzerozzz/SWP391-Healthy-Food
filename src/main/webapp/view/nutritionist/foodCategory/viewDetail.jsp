          ...
          <div class="main-content">
            ...
            <div class="main-content-inner">
              ...
              <div class="main-content-wrap">
                ...
                <form class="view_category" action="${pageContext.request.contextPath}/manageCategory?action=viewDetail"
                  method="GET">
                  <div class="wg-box">
                    <div class="left">
                  ...
                  <div class="bot">
                    <button type="button"
                      onclick="window.location.href = '${pageContext.request.contextPath}/manageCategory'">Back</button>
                  </div>
