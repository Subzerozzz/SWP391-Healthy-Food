...
//xư ly số khi ngươi dùng nhập vao
            ...
            if (isSuccess) {
                ...
                request.getSession().setAttribute("toastMessage", "Thêm CategorFood thất bại!");
                request.getSession().setAttribute("toastType", "Fail");
                request.getRequestDispatcher("/view/nutritionist/foodCategory/category_add.jsp").forward(request, response);
                return;
            }
        } catch (Exception e) {
            request.getSession().setAttribute("totalMess", "Fail Add Category");
    ...
    private void updateCategory(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            if (isSuccess) {
                ...
                request.getSession().setAttribute("toastMessage", "Edit Category thất bại!");
                request.getSession().setAttribute("toastType", "Fail");
