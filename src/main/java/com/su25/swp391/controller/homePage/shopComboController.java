 ...
 * @author Hang
 */
@WebServlet(name="shopComboController", urlPatterns={"/shopCombo"})
public class shopComboController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet shopComboController</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet shopComboController at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    private void filterCombo(HttpServletRequest request, HttpServletResponse response) {
